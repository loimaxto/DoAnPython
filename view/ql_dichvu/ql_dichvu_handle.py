...
class ql_dichvu_ui(QtWidgets.QWidget, Ui_Form):
    ...
    def insert_item(self):
        ...
        if ten=="" or gia=="":
            msg = QMessageBox();msg.setWindowTitle("Cảnh báo");msg.setText("Vui lòng điền đủ thông tin dịch vụ!");msg.setIcon(QMessageBox.Icon.Warning);msg.exec()
            return
        try:
    ...
    def delete_item(self):
        ...
        id = self.selec_row()
        if id==None:
            msg = QMessageBox();msg.setWindowTitle("Cảnh báo");msg.setText("Hãy chọn dịch vụ muốn xóa!");msg.setIcon(QMessageBox.Icon.Warning);msg.exec()
            return
